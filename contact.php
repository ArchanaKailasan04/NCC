        ...
        <div class="row">
          <div class="col-md-10 ml-auto mr-auto">
            <div class="card card-contact no-transition">
              <h3 class="card-title text-center">Contact Us</h3><br/>
              <small class= "text-center" id="response"></small>
              <div class="row">
                  ...
                  <div class="card-body">
                    <div class="info info-horizontal">
                      ...
                      <div class="description">
                        ...
                        <p> MES COLLEGE MARAMPALLY 
                          <br> Marampally P O,
                          <br>North Vazhakulam, Aluva
                          <br>Ernakulam (Dist)
                          <br>Kerala, India
                          <br>Pincode - 683 107
                        </p>
                  ...
                  <form role="form" id="contact_form" method="post">
                    <div class="card-body">
                      ...
                      <div class="form-group label-floating">
                        ...
                        <textarea class="form-control" rows="6" placeholder="Message" id="text" name="text"></textarea>
                      </div>
                      <div class="row">
                        
                        <div class="col-md-6 ">
                          <button type="submit" class="btn btn-primary pull-right" id="ct_btn" name="ct_btn">Send Message</button>
                        </div>
                      </div>
                    </div>
                  </form>
