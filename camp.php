      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 class="title"><i class="fas fa-bell" style="font-size: 48px;"></i> Camp New Notifications</h2>
            <p>Information provided by admin such as datesheet, Notice board, camp pattern post here. You can download the info in respected formats.</p>
            <hr>
          </div>
        </div>
