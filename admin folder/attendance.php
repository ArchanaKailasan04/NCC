    ...
    <p id="att_response"></p>
                  ...
                  <form id="att_form" method="post" class="form-horizontal">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group bmd-form-group">
                          <input type="date" class="form-control" name="cdate" id="cdate" max="<?= date('Y-m-d'); ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group bmd-form-group">
                          <div class="dropdown bootstrap-select">
                            <select class="selectpicker" name="type"data-style=" btn-primary btn-round" >
                            
                            <option selected=""  value="Parade">Parade</option>
                            <option selected=""  value="Event">Event</option>
                            <option selected=""  value="Exam">Exam</option>
                            <option selected="" disabled="" value="Type">...Select Type...</option>

                              <option value="<?php echo $jsons['type']; ?>"></option>
                          ...
                          <div class="form-check form-check-inline">
                            ...
                            <div class="form-check">
                              <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="mark" id="mark" value="1" > Present
                                <span class="circle">
            ...
            <div class="col-md-12">
              ...
              <div class="card ">
                <div class="card-header card-header-primary card-header-text">
                  <div class="card-text">
                    <h4 class="card-title">Report Parade Attendance</h4>
                  </div>
                </div>
                      ...
                      <div class="col-sm-10">
                        <div class="form-group bmd-form-group">
                          <div class="dropdown bootstrap-select">
                            ...
                            <?php 
                                     $sql_prepare = 'SELECT type FROM attendance';
                                                    $stmt = $con->prepare($sql_prepare); 
                                                   // $stmt->bind_param('i',$_GET['event']);
                                                    $stmt->execute();
                                 ...
                                 while($stmt->fetch())
                                 {
                                   $jsons = array('type'=>$type);
                              ?> 
                                      <option value="<?php echo $jsons['type']; ?>"><?php echo $jsons['type']; ?></option>
                                <?php
                                }?>
                          </select>
                        </div>
          ...
          <?php
                ...
                if(isset($_POST['cadet_id']) && isset($_POST['type']) && isset($_POST['cdate_from']) && isset($_POST['cdate_to']) )
                {
                  ...
                  <div class="material-datatables">
                    <table id="report_datatable" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <?php 
                             $sql_prepare = "select attend_id,cid,stats,cdate from attendance where cdate between '".$_POST['cdate_from']."' and '".$_POST['cdate_to']."' and type='".$_POST['type']."' ";
                                            $stmt = $con->prepare($sql_prepare); 
                      ...
                      ?> 
                        ...
                        <tr>
                          ...
                          <td><?php 
                                  ...
                                  }else if($jsons['stats']==2)
                                  {
                                    echo '<button class="btn btn-danger btn-sm" disabled>Absent<div class="ripple-container"></div></button>';
                                     
                                  }else
                                  {
                                     echo '<button class="btn btn-danger btn-sm" disabled><div class="ripple-container"></div></button>';
                                  }
