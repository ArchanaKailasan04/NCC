           ...
           <li class="nav-item ">
            <a class="nav-link" href="dashboard.php?page=6">
              ...
              <li class="nav-item ">
                 ...
                 <li class="nav-item ">
                  <a class="nav-link collapsed" data-toggle="collapse" href="#camp" aria-expanded="false">
                   <i class="fas fa-tasks" ></i>
                    <p>Manage Camps
                      <b class="caret"></b>
                    </p>
                  </a>
                  <div class="collapse" id="camp" style="">
                    <ul class="nav">
                      <li class="nav-item ">
                        <a class="nav-link" href="dashboard.php?page=16">
                          <span class="sidebar-mini"> AC </span>
                          <span class="sidebar-normal"> Add Camps </span>
                        </a>
                      </li>
                      <li class="nav-item ">
                        <a class="nav-link" href="dashboard.php?page=17">
                          <span class="sidebar-mini"> LC </span>
                          <span class="sidebar-normal"> List Camps</span>
                        </a>
                      </li>
                    </ul>
                  </div>
